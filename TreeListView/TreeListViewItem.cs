...
namespace System.Windows.Forms
{
	...
	public class TreeListViewItem : ListViewItem
	{
		public class sizecl
		{
			...
			public string getSizeString()
			{
				...
				if (s1 < 0)
					...
					return s1.ToString("N2") + "KB";
				else
				{
					s1 /= 1024;
					if (s1 < 1024)
						return s1.ToString("N2") + "MB";
					else
					{
						s1 /= 1024;
						if (s1 < 1024)
							return s1.ToString("N2") + "GB";
						else
						{
							s1 /= 1024;
							return s1.ToString("N2") + "TB";
						}
					}
				}
			}
		...
		public sizecl nodeSize = new sizecl();
		...
		new public string Text
		{
			...
			set
			{
				...
				if (collection != null&&this.ListView.doSort)
